		...
		<div class="rounded-xl border border-gray-800 bg-gray-900/30 p-4">
			...
			<div class="space-y-2 text-xs text-gray-500">
				<div class="flex items-center justify-between">
					<span>Logiciel</span>
					<span class="text-gray-400 font-medium">Nodyx{#if instance.version}&thinsp;<span class="text-gray-600 font-mono">v{instance.version}</span>{/if}</span>
				</div>
				<div class="flex items-center justify-between">
					<span>Réseau</span>
			...
			<div class="mt-4 pt-3 border-t border-gray-800">
				<a href="https://github.com/Pokled/Nodyx" target="_blank" rel="noopener"
