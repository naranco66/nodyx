...
<div class="relative mb-6 overflow-hidden rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900 via-gray-900 to-violet-950/30 p-8 shadow-xl">
	...
	<div class="relative">
		...
		<p class="text-gray-400 text-sm mb-5">Recherchez du contenu sur toutes les instances Nodyx connectées au réseau.</p>
...
{:else if !data.error}
	<div class="flex flex-col items-center justify-center py-20 text-center">
		...
		{:else}
			...
			<p class="text-gray-600 text-xs">Les instances avec <code class="bg-gray-800 px-1 rounded">NODYX_GLOBAL_INDEXING=true</code> apparaîtront ici.</p>
		{/if}
	</div>
{/if}
