...
The SvelteKit 5 frontend for [Nexus](../README.md) — the self-hosted community platform.
...
| `/settings` | User settings — linked instances, Nexus Signet devices |
...
| `src/lib/canvas.ts` | NexusCanvas — CRDT LWW state, P2P sync |
...
├── nexus-relay/          ← Rust P2P TCP tunnel (home servers)
